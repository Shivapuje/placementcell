...
<body>
  <div class="container-fluid" style="left:0;right:0;">
      <nav class="navbar navbar-inverse" style="font-size:25px;padding:1px;">
          <ul class="topnav nav nav-pills">
            <li><b style="font-size:40px;color:#ffffff;">  Placementcell</b></li>
  ...
  <!--Navigation bar ends-->
    <div class="container">
      ...
      <div class="col-md-7 line-border" style="width:700px; font-family: 'Exo', sans-serif;">
        <h2><b style="color:#ab0033;">STACKUP. LOAD UP. HIRED UP.</b></h2>
